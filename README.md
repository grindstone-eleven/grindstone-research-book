...
timeline
    ...
    Sep 2 : the critic leaves - one gesture, vado, hands the question to a means and the hand comes back : calendar and disk become organs with one mandate each : the web is rewritten with its eyes inside - cold benches only
